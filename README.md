...
For each year and for each type of PM source, the NEI records how many tons of PM2.5 were emitted from that source over the course of the entire year. The data that you will use for this assignment are for 1999, 2002, 2005, and 2008. https://www3.epa.gov/cgi-bin/broker?polchoice=PM&_debug=0&_service=data&_program=dataprog.national_1.sas#pmnat
